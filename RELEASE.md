...
## 3. Archive
```sh
xcodebuild -project SpeechSteps.xcodeproj -scheme SpeechSteps \
  -configuration Release -archivePath build/SpeechSteps.xcarchive \
...
```sh
xcodebuild -exportArchive -archivePath build/SpeechSteps.xcarchive \
  -exportOptionsPlist build/ExportOptions.plist -exportPath build/export

xcrun altool --upload-app -f build/export/SpeechSteps.ipa -t ios \
